...
fetch(`./assets/languages/${language}.json`)
    ...
    .then(data => {
        ...
        const errors = {
            usernameTaking: data.body.username?.usernameTaking,
            usernameNotValidLengthLong: data.body.username?.usernameNotValidLengthLong,
            usernameNotValidLengthShort: data.body.username?.usernameNotValidLengthShort,
            usernameNotValidCharacters: data.body.username?.usernameNotValidCharacters,
            emailTaking: data.body.email?.emailTaking,
            emailNotValidPattern: data.body.email?.emailNotValidPattern,
            passwordNoUppercaselowercase: data.body.password?.passwordNoUppercaselowercase,
            passwordNotValidLength: data.body.password?.passwordNotValidLength,
            passwordsMatch: data.body.password?.passwordsMatch
        };
